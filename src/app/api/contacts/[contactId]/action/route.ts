...
import { syncCanvassResponse } from '@/lib/crm-sync'
...
export async function PUT(request: NextRequest, { params }: { params: { contactId: string } }) {
  try {
    ...
    if ('contactOutcome' in body) {
      ...
      syncCanvassResponse(ctx.campaignId, contactId, body.contactOutcome as string, body.outreachMethod as string | null)
